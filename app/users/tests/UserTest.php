...
class UserTest extends \PHPUnit_Framework_TestCase
{
    ...
    public static $instagramProfile;
    ...
    public static function setUpBeforeClass()
    {
        ...
        self::$twitterProfile->create([
            'id' => 100,
            'profile_image_url' => 'twitter_profile_picture', ]);

        self::$instagramProfile = new InstagramProfile();
        self::$instagramProfile->create([
            'id' => 100,
            'profile_picture' => 'instagram_profile_picture', ]);
    }
