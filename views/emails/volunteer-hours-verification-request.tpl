...
<table>
  <tr>
      <td align="center" width="240" bgcolor="#5aba66" style="background: #5aba66; padding-top: 6px; padding-right: 10px; padding-bottom: 6px; padding-left: 10px; -webkit-border-radius: 4px; -moz-border-radius: 4px; border-radius: 4px; color: #fff; font-weight: bold; text-decoration: none; font-family: Helvetica, Arial, sans-serif; display: block;"><a href="{$approval_link}" style="color: #fff; text-decoration: none;">Yes, this is correct</a></td>
  </tr>
</table>
