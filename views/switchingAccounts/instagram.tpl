...
<div class="body skinny minimal container">
	...
	<p>
		You are currently logged in as <strong>{$app.user->name()}</strong>. The Instagram account
	...
	<p>
		<a href="/instagram/connect?forceLogin=t" class="btn btn-lg btn-block btn-primary">
			Yes, switch accounts
		</a>
	</p>

	<p>
		<a href="/instagram/connect" class="btn btn-default btn-block">
			No, use another Instagram account
		</a>
	</p>
</div>
